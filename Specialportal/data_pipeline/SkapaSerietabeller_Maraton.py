...
DASHBOARD_TITEL = "Svensk Fotbollshistoria - Nationella seriesystemet"

# Vilken Excel-fil ska systemet leta efter? 
EXCEL_FILNAMN_SOKORD = "Serietabellerna_samlade"

# Vad ska den färdiga, klickbara hemsidan heta?
HTML_UTDATA_FILNAMN = "Fotbollsanalys_Dashboard.html"
                ...
                if (mode === 'laglista') {
                    ...
                    document.getElementById('bildadHead').innerHTML = `
                        <tr>
                            <th class="px-4 py-3">Plac</th>
                            <th class="px-4 py-3">Lag</th>
                            <th class="px-4 py-3 text-center text-blue-700 font-bold">Bildad</th>
                            <th class="px-4 py-3 text-center">Sp</th>
                    ...
                    let htmlHead = `<tr><th class="px-4 py-3">Decennium (Bildad)</th><th class="px-4 py-3 text-center border-l">Totalt Antal Lag</th>`;
