...
ind_keys = [
    ...
    'ind_lagekon', 'ind_lagink', 'ind_trang', 'ind_kvm', 'ind_ensam', 'ind_forgym', 
    'ind_ohalsa', 'ind_uvas', 'ind_utrfod', 'ind_utlbak', 'ind_val'
]
...
if not pop_df.empty:
    ...
    if not pop_df_valid.empty:
        ...
        if 'NYKO6' in pop_df_valid.columns:
            ...
            # Exkludera 146300 enligt önskemål (Men tillåt 1463)
            if EXCLUDE_146300:
...
for idx, row in nyko4.iterrows():
    ...
    nyko4_data.append({
        ...
        # Alla 16 Indikatorer (inkl ohälsotal)
...
# Hög precision för att undvika glapp, men tillräckligt för att banta filen
...
<script>
    document.addEventListener('DOMContentLoaded', function() {{
        ...
        map.getPane('stangaPane').style.zIndex = 460; // Garanterar att Stångåstaden alltid är klickbar!
        ...
        function updatePolygonVisibility(doZoom) {{
            ...
            if (topBotFilter !== 'all' && activeBase !== 'none') {{
                var propMapKeys = {{
                    ...
                    'ind_ensam': 'ind_ensam', 'ind_forgym': 'ind_forgym', 'ind_ohalsa': 'ind_ohalsa', 'ind_uvas': 'ind_uvas',
            ...
            var baseToClass = {{
                ...
                'ind_ensam': 'ind-ensam-polygon', 'ind_forgym': 'ind-forgym-polygon', 'ind_ohalsa': 'ind-ohalsa-polygon', 'ind_uvas': 'ind-uvas-polygon',
        ...
        document.getElementById('btn-zoom-selected').addEventListener('click', function() {{
            ...
            var hasCharFilter = activeCharFilter !== "";
        ...
        document.getElementById('btn-reset').addEventListener('click', function() {{
            ...
            if (document.getElementById('toggleStanga').checked) document.getElementById('toggleStanga').click();
            map.fitBounds(initialBounds);
            ...
            var tabsHtml = `
                ...
                <div class="tab-content" style="padding-top: 12px;">
                    ...
                    <div class="tab-pane fade" id="tab-sei">
                        ...
                        <div class="d-flex justify-content-between mb-1" style="font-size:12px;"><span>Ohälsotal 50-64 år:</span><span class="fw-bold">${{d.ind_ohalsa !== null && d.ind_ohalsa > 0 ? d.ind_ohalsa : '-'}}</span></div>
        ...
        function buildAdvancedPopup(title, lat, lon, extraHtml, demoData = null, hideDistance = false) {{
            ...
            var demoTitle = demoData ? "Demografi (Hela området)" : "Demografi (1 km radie)";
            
            var titleBlock = title !== "" ? `<b style="font-size:15px; color:#2c3e50;">${{title}}</b><hr style="margin:5px 0;">` : "";
            
            var distanceBlock = hideDistance ? "" : `
                <div style="display:flex; justify-content:space-between; margin-bottom:5px; gap: 5px;">
                    <div style="flex:1; background:#f8f9fa; padding:5px; border-radius:4px; border:1px solid #eee;">
            ...
            var html = `<div style="min-width:100%; font-size:12px; font-family:sans-serif;">
                ${{titleBlock}}
                ${{distanceBlock}}
